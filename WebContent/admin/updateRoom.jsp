...
<%
	...
	while(it.hasNext()){
		r=it.next();
		if(r.getrId().equals(sid)){
			
		
%>
	<tr>
	<td><input type="text" name="rId" readonly="true" value=<%=r.getrId() %>></td>
	<td><input type="text" name="rName" value=<%=r.getrName() %>></td>
	<td><input type="text" name="rPrice" value=<%=r.getrPrice() %>></td>
	<td><input type="text" name="rStock" value=<%=r.getrStock() %>></td>
