...
<!-- Add your site or app content here -->
  ...
  <div class="section-container">
   ...
   table{
	...
	<td>价格</td>
	<td>库存</td>
	<td><input id="btn2" type="button" value="批量删除" onclick="delAllRoom();"/></td>
...
%>
	<tr>
	<td><input type="checkbox" name="check" value=<%=r.getrId() %>></td>
	<td><%=r.getrId() %></td>
	<td><%=r.getrName() %></td>
	<td><%=r.getrPrice() %></td>
	<td><%=r.getrStock() %></td>
	<td><a href="updateRoom.jsp?rid=<%=r.getrId() %>">修改</a></td>
	
	<td>
	<a href="updateRoom?f=del&rid=<%=r.getrId() %>"
...
<form action="adminregisterroom">
 <table>
	...
	<td><input type="text" name="rprice" id="rprice"></td>
	<td><input type="text" name="rstock" id="rstock"></td>
